...
<div class=content> <!-- hold all content for the page -->
    ...
    <p>
    In this example neither the HTML document, stylesheet nor script are compressed. Reload the page several times and compare the response times to the other examples. This example is slower than both Example 2 - HTML Gzipped and Example 3 - Everything Gzipped.
