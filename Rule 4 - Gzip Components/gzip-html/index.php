...
<head>
    ...
    <script>
        ...
        // We can't serve this in PHP because we can't disable gzip on PHP (shared server).
        // Since this is static HTML we use JS to write a time value in the URL to break cache.
        document.writeln('<link rel="stylesheet" href="test-nogzip.css?t=' + Number(new Date()) + '" type="text/css">');
        document.writeln('<scr' + 'ipt src="test-nogzip.js?t=' + Number(new Date()) + '"></scr' + 'ipt>');
...
<div class=header>Rule 4 - Gzip Components</div>
<div class=subheader>
    Example 3 - Everything Gzipped
</div>
<div class=content> <!-- hold all content for the page -->
    ...
    <p>
    In this example only the HTML document is compressed. The stylesheet and script are not compressed. Reload the page several times and compare the response times to the other examples. This is faster than Example 1 - Nothing Gzipped but slower than Example 3 - Everything Gzipped.
