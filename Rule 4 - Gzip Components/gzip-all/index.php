...
<div class=content> <!-- hold all content for the page -->
    ...
    <p>
    In this example the HTML document, stylesheet and script are all compressed. Reload the page several times and compare the response times to the other examples. This is faster than both Example 1 - Nothing Gzipped and Example 2 - HTML Gzipped.
