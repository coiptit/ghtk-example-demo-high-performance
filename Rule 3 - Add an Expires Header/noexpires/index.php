...
<p>
This example contains six images, three scripts and one stylesheet that do not have a far future Expires header.Load the page several times using the "try it again" link and compare the response time to Example 2 - Far Future Expires. This example is slower because it has to make ten additional HTTP requests.
